  ...
  return (
    <Fragment>
      ...
      <div className="flex flex-col items-center ">
        ...
        <p className="text-lg mt-2 text-gray-600">Click the button below to update your profile.</p>
        <Link to="/profile">
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-black shadow-md rounded-lg p-3  flex flex-col items-center justify-center text-white">
